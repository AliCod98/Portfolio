    ...
    <div class="header w-full flex flex-col lg:flex-row" style="height:80vh">
      <div class="share-buttons fixed top-36 left-3 lg:left-6">
        <div class="share-button">
          <div class="share-button-secondary">
            <div class="share-button-secondary-content">@ali_ben_lhoucine</div>
          </div>
          <a href="https://www.linkedin.com/in/ali-ben-lhoucine/" target="_blank">
        ...
        <div class="share-button">
          <div class="share-button-secondary">
            <div class="share-button-secondary-content">@AliBenlahoucine</div>
          </div>
          <a href="https://www.facebook.com/profile.php?id=100055660808727" target="_blank">
            <div class="share-button-primary">
        ...
        <div class="share-button">
          <div class="share-button-secondary">
            <div class="share-button-secondary-content">@ali.benlahoucine</div>
          </div>
          <a href="https://www.instagram.com/ali.benlahoucine/" target="_blank">
            <div class="share-button-primary">
        ...
        <div class="share-button">
          <div class="share-button-secondary">
            <div class="share-button-secondary-content">@AliCod98</div>
          </div>
          <a href="https://github.com/AliCod98" target="_blank">
            <div class="share-button-primary">
        ...
        <div class="share-button">
          <div class="share-button-secondary">
            <div class="share-button-secondary-content">benlahoucine123@gmail.com</div>
          </div>
          <div class="share-button-primary">
      ...
      <div class="text-left lg:h-full h-2/3 lg:w-2/3 w-full ml-8 flex justify-center flex-col">
        <h1
          ...
          data-text="Ali Benlahoucine"
        >
          <p class="font-bold mb-2 text-xs md:text-sm md:mb-5" style="color:#139487 ">Hi, my name is</p>Ali Benlahoucine
        </h1>
        ...
        <div id="container " class="button z-20 w-4/5 mt-5 lg:mt-11">
          <a href="https://flowcv.me/alicod98" target="_blanck">
